...
if [ $t -eq 1 ]; then	
	...
	python3 CODE/main.py --train -x actin -y junction -e 400 -a .5 --lr .00001 --dice_steps 100 --lr_step 100 --ga 1. --save 1 --n_layers=4 --cuda cuda:$c --data_path=$dd
...
#name_outline="pred_junction_outline_mix_0.0_kernel_5_nlayers_4_ds_0_lrstep_100_ws_200_fl_0_bdy_10_mrg_40_3"
...
#python3 CODE/predict.py -x pred_junction -y outline  --pred_folder_name=$name --#model_name=$name_outline --device $c --data_path=$dd
