...
if [ $t -eq 1 ]; then
    python3 CODE/main.py --train -x junction -y outline -e 200 --lr=.00001 --lr_step=100 --kernel_size 5 --padding 2 -a 0.0 --save 1 --reduced $r --margin 0 --data_path "./data" --ga 1. --cuda cuda:$c --bdy=10 --mrg=40
