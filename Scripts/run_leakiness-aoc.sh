...
if [ $t -eq 1 ]; then	    
	...
	python3 CODE/main.py --train -x $x_prefix -y leakiness -e 200 --batch_size=32 --window_size=200 --lr=.000001 --n_window 200 --lr_step=50 --ga .5 --zero_weight=0.4 --leak_thresh=0.1 -a 1. -k 5 -p 2 --n_layers 4 --save 1 --data_path $dd --cuda cuda:$c --pname=$name --bdy=10 --mrg=40
